...
//console.log("INFO");
let serverLocation = "http://127.0.0.1:5000/champselect";
function getInfo() {
    //console.log("HenterInfo");
    var xhr = new XMLHttpRequest();
    console.log(window.location.href);
    xhr.open('GET', serverLocation + "/json", true);
    xhr.send();
        ...
        if (xhr.readyState == 4 && xhr.status == 200 ) {
            ...
            for (var i = 0; i < 5; i++) {
                ...
                if (response.team.theirTeam[i] != undefined) {
                    ...
                    //Summoners
                    if (response.team.theirTeam[i].SummonerSpell1 == undefined || response.team.myTeam[i].SummonerSpell1 == "None") {
...
function getTimer() {
    ...
    var xhr = new XMLHttpRequest();
    xhr.open('GET', serverLocation + "/timer", true);
    xhr.send();
    xhr.onreadystatechange = processRequest;
    function processRequest(e) {
        //console.log(xhr.readyState)
